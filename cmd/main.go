...
func main() {
	...
	flag.StringVar(&certDir, "cert-dir", "/tmp/k8s-webhook-server/serving-certs", "The directory where the TLS certs are located.")
	opts := zap.Options{
		Development: true,
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "c6e41798.questdb.io",
	...
	if err = (&crdv1beta1.QuestDB{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "QuestDB")
		os.Exit(1)
	}
	if err = (&crdv1beta1.QuestDBSnapshotSchedule{}).SetupWebhookWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create webhook", "webhook", "QuestDBSnapshotSchedule")
		os.Exit(1)
	}
