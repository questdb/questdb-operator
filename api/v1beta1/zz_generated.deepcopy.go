...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QuestDBIngressSpec) DeepCopyInto(out *QuestDBIngressSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QuestDBIngressSpec.
func (in *QuestDBIngressSpec) DeepCopy() *QuestDBIngressSpec {
	if in == nil {
		return nil
	}
	out := new(QuestDBIngressSpec)
	in.DeepCopyInto(out)
	return out
}
